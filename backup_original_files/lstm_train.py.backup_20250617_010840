...
steps = 1
learning_rate = 0.001
alpha = 0.1 # Retain alpha for now, can be set to 0 to test pure MSE for LSTM

# LSTM specific hyperparameters
lstm_hidden_dim = 64 # Example value, can be tuned
lstm_num_layers = 2  # Example value, can be tuned
lstm_dropout_prob = 0.1 # Example value, can be tuned
