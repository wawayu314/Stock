...
# 设置要训练的市场 - 可以轻松切换以下市场：
# market_name = 'A_SHARE'   # S&P 500数据集
market_name = 'A_SHARE'  # NASDAQ数据集
# market_name = 'A_SHARE'    # NYSE数据集
...
if market_name == "SP500":
    ...
    mask_data = (price_data > 1e-6).astype(float) # 基于价格创建真实的掩码
    eod_data = data # EOD数据
