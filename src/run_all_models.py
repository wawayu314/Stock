...
def check_environment():
    ...
    if MARKET_NAME == 'SP500':
        ...
        nasdaq_files = [
            '../dataset/NASDAQ/eod_data.pkl',
            '../dataset/NASDAQ/mask_data.pkl', 
            '../dataset/NASDAQ/gt_data.pkl',
            '../dataset/NASDAQ/price_data.pkl'
        ]
        for file_path in nasdaq_files:
            if not os.path.exists(file_path):
                issues.append(f"NASDAQ数据文件不存在: {file_path}")
